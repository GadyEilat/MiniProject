	...
	public void handleMessageFromClient(Object msg, ConnectionToClient client) {
		...
		case UPDATEINFO_REQUEST:
			if(object instanceof ParkInfo) {
				...
				String UpdateQuery = "UPDATE gonature.manageparkstoapprove SET Approve = '0', maxVisitors = '" + parkInfo.getMaxVisitors() +"',"
						+ " gapOfVisitors = '" + parkInfo.getGapOfVisitors() + "',"
						+ " maxHourToVisit = '"+ parkInfo.getMaxHourToVisit() +"' WHERE numberOfPark = '"+ parkInfo.getNumberOfPark() + "';";
